...
export default function EntreprenorPage() {
  ...
  useEffect(() => {
    localStorage.setItem(ROLE_STORAGE_KEY, "entreprenor");
  }, []);
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto mt-4 max-w-7xl px-6 lg:px-8">
        <RoleSwitcher current="entreprenor" />
      </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col gap-6 text-sm text-[#766B60] md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex gap-6">
              ...
              <Link href="/konto?role=entreprenor" className="hover:text-[#8C7860]">Kom igång</Link>
            </div>
          </div>
        </div>
      </footer>
